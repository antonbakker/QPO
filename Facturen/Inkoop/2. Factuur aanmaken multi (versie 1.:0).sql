...
/*  case when  g.btw_code = ''13    '' then ''9'' else ''5'' end BTWcode,*/
   case when RTRIM(g.btw_code) = ''13'' then ''9'' else ''5'' end BTWcode,
       g.freefield1
...
WHERE  1 = 1 
	   ...
	   GROUP BY g.docnumber, g.datum, g.docdate, g.bkstnr, g.debnr,
                 g.faktuurnr,  g.oms25, g.kstdrcode, g.freefield1,  g.reknr,case when  RTRIM(g.btw_code) = ''13'' then ''9'' else ''5'' end						'
