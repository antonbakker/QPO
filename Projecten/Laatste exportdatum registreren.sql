insert into QSagroSoftProject 

	select top 1 projectcode,sysmodified from
...
-- WHERE     ([561].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([527].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([541].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([523].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([524].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([522].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([525].dbo.PRProject.Status = 'A')
...
-- WHERE     ([543].dbo.PRProject.Status = 'A')
UNION ALL
...
-- WHERE     ([512].dbo.PRProject.Status = 'A')
...
-- WHERE     ([528].dbo.PRProject.Status = 'A')
union all
...
-- WHERE     ([547].dbo.PRProject.Status = 'A')
...
WHERE     projectexact.sysmodified > (select MAX(exportdatum) from QSagroSoftProject)
