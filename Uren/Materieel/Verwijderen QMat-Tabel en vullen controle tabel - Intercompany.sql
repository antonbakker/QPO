drop table QSagroSoftUrenMatIC
-- adm 546 niet aanwezig
delete from Q_idcontrole_mat_IC
insert into Q_idcontrole_mat_IC
select * from
(
select distinct  freefield5  from [512]..gbkmut
where dagbknr =' 99' and project is not null and reknr ='     5925' and transtype  not in( 'V')
